...
const COBRA_TOOLS = [
  ...
  { type:'function', function:{ name:'check_emails', description:'Legge email recenti dalla casella IMAP.', parameters:{ type:'object', properties:{ limit:{ type:'number' } }, required:[] } } },
