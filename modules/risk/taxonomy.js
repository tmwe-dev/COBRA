...
const TOOL_RISK_TAXONOMY = {
  ...
  cosa_so_del_sito:      { level:'read', confirm:false, batchable:true, truth:'Cosa si sa gia\' di un sito.' },
  annota_sul_sito:       { level:'write_local', confirm:false, batchable:true, truth:'Segna una cosa imparata su un sito. Scrive solo nella memoria locale.' },
  impara_procedura:      { level:'write_local', confirm:false, batchable:false, truth:'Registra una procedura ripetibile. Scrive solo nella memoria locale.' },
  usa_procedura:         { level:'read', confirm:false, batchable:true, truth:'Prepara una procedura gia\' imparata.' },
  elenco_procedure:      { level:'read', confirm:false, batchable:true, truth:'Elenca le procedure imparate.' },
