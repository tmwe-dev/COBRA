...
cd "$(dirname "$0")" || exit 1
FAIL=0
TESTS="tests/verify-all.js tests/test-tool-pipeline.js tests/check-ctx-methods.js tests/check-bridge-protocol.js tests/test-kb-search.js tests/test-ssrf.js tests/test-security-runtime.js tests/test-data-integrity.js tests/test-learning.js tests/test-imap.js tests/test-mail-autoconfig.js tests/test-monitor-tabs.js tests/test-page-injection.js tests/test-fabrication-guard.js tests/test-process.js"
for t in $TESTS; do
